        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="purple"> machine learning, AI, Data Analyis and web development </b>
              </i>
              <br />
              <br />
              My field of Interest's are building new &nbsp;
              <i>
                <b className="purple">Machine learning app ,  Web applications  </b> and
              ...
              with <b className="purple">TensorFLow & Keras</b> and
              <i>
                <b className="purple">
                  {" "}
